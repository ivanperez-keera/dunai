...
-- | 'RModule' instance for tuples with 3 elements.
...
-- | 'VectorSpace' instance for tuples with 3 elements.
instance Fractional a => VectorSpace (a,a,a) where
    (x,y,z) ^/ a = (x / a, y / a, z / a)

-- | 'InnerProductSpace' instance for tuples with 3 elements.
...
-- | 'RModule' instance for tuples with 4 elements.
...
-- | 'VectorSpace' instance for tuples with 4 elements.
instance Fractional a => VectorSpace (a,a,a,a) where
    (x,y,z,u) ^/ a = (x / a, y / a, z / a, u / a)

-- | 'InnerProductSpace' instance for tuples with 4 elements.
...
-- | 'RModule' instance for tuples with 5 elements.
...
-- | 'VectorSpace' instance for tuples with 5 elements.
instance Fractional a => VectorSpace (a,a,a,a,a) where
    (x,y,z,u,v) ^/ a = (x / a, y / a, z / a, u / a, v / a)

-- | 'InnerProductSpace' instance for tuples with 5 elements.
